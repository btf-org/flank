...
## He _just_ needed a couple more features

His laptop could almost get him there, but he really needed the following for this to work:
...
The big tradeoff is that Nick is accepting a little bit of EC2 machine management in order to keep everything else (running, viewing logs, deploying) as simple as possible.
